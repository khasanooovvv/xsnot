(() => {
 ...
 if(reason){
   ...
   upgrade.textContent=reason==='weekly_dm_limit'?'Gold Plus’ga o‘tish':'Gold olish';
   upgrade.onclick=()=>showPremiumSheet(reason==='weekly_dm_limit'?'plus':'gold');box.append(upgrade);
 }
