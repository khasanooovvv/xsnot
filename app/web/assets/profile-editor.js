(() => {
  ...
  const usernameStyle=document.createElement('style');usernameStyle.textContent='.username-list-row{display:flex;align-items:center;gap:10px;width:100%;padding:9px;text-align:left;border:0;border-top:1px solid var(--border);border-radius:0;color:var(--text);background:transparent}.username-list-row span:nth-child(2){min-width:0;flex:1}#usernameDetail{width:min(94vw,440px);padding:20px;border:1px solid var(--border);border-radius:24px;background:var(--surface);color:var(--text)}#usernameDetail::backdrop{background:#0008}.username-back{width:42px!important;padding:5px!important;background:transparent!important;color:var(--text)!important;font-size:28px!important}.username-detail-card{margin-top:12px;padding:16px;border-radius:18px;background:var(--surface-2)}.username-detail-card>b{display:block;color:var(--accent);margin-bottom:12px}.username-detail-input{display:flex;align-items:center;gap:4px;padding:12px;border-radius:14px;background:var(--surface);border:1px solid var(--border);color:var(--muted)}.username-detail-input input{margin:0!important;padding:0!important;border:0!important;background:transparent!important;color:var(--text)!important}.username-detail-help{color:var(--muted);line-height:1.5}';document.head.append(usernameStyle);
