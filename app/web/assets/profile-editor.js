(() => {
  ...
  const usernameStyle=document.createElement('style');usernameStyle.textContent='.username-entry{display:none!important}.username-settings #addUsername{display:none!important}.username-list-row{display:flex;align-items:center;gap:10px;width:100%;padding:12px 15px;text-align:left;border:1px solid #aab9c4;border-radius:18px;color:var(--text)!important;background:linear-gradient(145deg,#ffffff,#e5ebef)!important;box-shadow:inset 0 1px #fff,0 5px 12px #71808b55}.username-list-row span:nth-child(2){min-width:0;flex:1}.username-list-row:hover{background:linear-gradient(145deg,#fff,#dce5eb)!important;transform:translateY(-1px)}#usernameDetail{width:min(94vw,440px);padding:20px;border:1px solid var(--border);border-radius:24px;background:var(--surface);color:var(--text)}#usernameDetail::backdrop{background:#0008}.username-back{width:42px!important;padding:5px!important;background:transparent!important;color:var(--text)!important;font-size:28px!important}.username-detail-card{margin-top:12px;padding:16px;border-radius:18px;background:var(--surface-2)}.username-detail-card>b{display:block;color:var(--accent);margin-bottom:12px}.username-detail-input{display:flex;align-items:center;gap:4px;padding:12px;border-radius:14px;background:var(--surface);border:1px solid var(--border);color:var(--muted)}.username-detail-input input{margin:0!important;padding:0!important;border:0!important;background:transparent!important;color:var(--text)!important}.username-detail-help{color:var(--muted);line-height:1.5}body.theme-dark .username-list-row{border-color:#536678;background:linear-gradient(145deg,#3a4b57,#293843)!important;box-shadow:inset 0 1px #ffffff22,0 5px 12px #0006}.username-list-row:hover{filter:brightness(1.08)}';document.head.append(usernameStyle);
