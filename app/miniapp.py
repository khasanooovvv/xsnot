...
@router.get('/assets/direct-ui.js')
async def direct_ui_script():
    return FileResponse(Path(__file__).parent / 'web' / 'assets' / 'direct-ui.js', media_type='application/javascript')

@router.get('/assets/direct-ui.css')
